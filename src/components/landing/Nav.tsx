    ...
    <header className="sticky top-0 z-40 border-b border-hairline bg-background/85 backdrop-blur-md">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-10">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 rounded-full bg-olive px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-olive-soft hover:text-ink"
        >
