        ...
        <Reveal>
          <div className="mb-14 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div className="max-w-2xl">
              <p className="text-[11px] uppercase tracking-[0.32em] text-olive">Proyectos reales</p>
              <h2 className="mt-5 text-3xl text-ink sm:text-4xl md:text-5xl">
                Pequeños cambios, grandes resultados.
              </h2>
              <p className="mt-5 max-w-lg text-sm leading-relaxed text-muted-ink sm:text-base">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 border-b border-olive pb-1 text-sm font-medium text-olive transition-colors hover:text-olive-deep"
            >
