      ...
      <div className="mx-auto max-w-5xl px-6 py-28 text-center sm:py-36 lg:px-10">
        <Reveal>
          <h2 className="text-3xl leading-tight sm:text-4xl md:text-5xl">
            ...
            <br />
            <span className="italic text-white/70">O puede sentirse completamente distinto.</span>
            <br />
          ...
          <div className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 rounded-full border border-white/40 px-8 py-4 text-sm font-medium tracking-wide text-white transition-colors hover:bg-white hover:text-ink"
            >
